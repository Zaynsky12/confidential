...
const INITIAL_MARKETS: Market[] = [
  ...
  { id: 'link-usdc', pair: 'LINK/USDC', baseAsset: 'LINK', quoteAsset: 'USDC', category: 'crypto', pythPriceId: '8ac0c70fff57e9aefdf5edf44b51d62c2d433653cbb2cf5cc06bb115af04d221', pythSymbol: 'Crypto.LINK/USD', price: 0, prevPrice: 0, change24h: 0, volume24h: 45600000, high24h: 0, low24h: 0, openInterest: 28000000, maxLeverage: 50 },
  { id: 'arb-usdc', pair: 'ARB/USDC', baseAsset: 'ARB', quoteAsset: 'USDC', category: 'crypto', pythPriceId: '3fa4252848f9f0a1480be62745a4629d9eb1322aebab8a791e344b3b9c1adcf5', pythSymbol: 'Crypto.ARB/USD', price: 0, prevPrice: 0, change24h: 0, volume24h: 18200000, high24h: 0, low24h: 0, openInterest: 12000000, maxLeverage: 50 },
  ...
  { id: 'sui-usdc', pair: 'SUI/USDC', baseAsset: 'SUI', quoteAsset: 'USDC', category: 'crypto', pythPriceId: '23d7315113f5b1d3ba7a83604c44b94d79f4fd69af77f804fc7f920a6dc65744', pythSymbol: 'Crypto.SUI/USD', price: 1.15, prevPrice: 1.10, change24h: 4.5, volume24h: 180000000, high24h: 0, low24h: 0, openInterest: 45000000, maxLeverage: 50 },
  { id: 'apt-usdc', pair: 'APT/USDC', baseAsset: 'APT', quoteAsset: 'USDC', category: 'crypto', pythPriceId: '03ae4db29ed4ae33d323568895aa00337e658e348b37509f5372ae51f0af00d5', pythSymbol: 'Crypto.APT/USD', price: 8.90, prevPrice: 8.85, change24h: 0.5, volume24h: 150000000, high24h: 0, low24h: 0, openInterest: 38000000, maxLeverage: 50 },
  { id: 'avax-usdc', pair: 'AVAX/USDC', baseAsset: 'AVAX', quoteAsset: 'USDC', category: 'crypto', pythPriceId: '93da3352f9f1d105fdfe4971cfa80e9dd777bfc5d0f683ebb6e1294b92137bb7', pythSymbol: 'Crypto.AVAX/USD', price: 35.00, prevPrice: 36.50, change24h: -4.1, volume24h: 210000000, high24h: 0, low24h: 0, openInterest: 55000000, maxLeverage: 50 },
  ...
  { id: 'near-usdc', pair: 'NEAR/USDC', baseAsset: 'NEAR', quoteAsset: 'USDC', category: 'crypto', pythPriceId: 'c415de8d2eba7db216527dff4b60e8f3a5311c740dadb233e13e12547e226750', pythSymbol: 'Crypto.NEAR/USD', price: 7.20, prevPrice: 6.80, change24h: 5.8, volume24h: 120000000, high24h: 0, low24h: 0, openInterest: 28000000, maxLeverage: 50 },
  // RWA Perps
  { id: 'aapl-usdc', pair: 'AAPL/USDC', baseAsset: 'AAPL', quoteAsset: 'USDC', category: 'rwa', pythPriceId: '49f6b65cb1de6b10eaf75e7c03ca029c306d0357e91b5311b175084a5ad55688', pythSymbol: 'Equity.US.AAPL/USD', price: 0, prevPrice: 0, change24h: 0, volume24h: 52000000, high24h: 0, low24h: 0, openInterest: 35000000, maxLeverage: 20 },
  { id: 'tsla-usdc', pair: 'TSLA/USDC', baseAsset: 'TSLA', quoteAsset: 'USDC', category: 'rwa', pythPriceId: '16dad506d7db8da01c87581c87ca897a012a153557d4d578c3b9c9e1bc0632f1', pythSymbol: 'Equity.US.TSLA/USD', price: 0, prevPrice: 0, change24h: 0, volume24h: 68000000, high24h: 0, low24h: 0, openInterest: 42000000, maxLeverage: 20 },
  { id: 'gold-usdc', pair: 'GOLD/USDC', baseAsset: 'GOLD', quoteAsset: 'USDC', category: 'rwa', pythPriceId: '765d2ba906dbc32ca17cc11f5310a89e9ee1f6420508c63861f2f8ba4ee34bb2', pythSymbol: 'Metal.XAU/USD', price: 0, prevPrice: 0, change24h: 0, volume24h: 120000000, high24h: 0, low24h: 0, openInterest: 85000000, maxLeverage: 50 },
  { id: 'silver-usdc', pair: 'SILVER/USDC', baseAsset: 'SILVER', quoteAsset: 'USDC', category: 'rwa', pythPriceId: 'f2fb02c32b055c805e7238d628e5e9dadef274376114eb1f012337cabe93871e', pythSymbol: 'Metal.XAG/USD', price: 0, prevPrice: 0, change24h: 0, volume24h: 64000000, high24h: 0, low24h: 0, openInterest: 32000000, maxLeverage: 50 },
  ...
  { id: 'nvda-usdc', pair: 'NVDA/USDC', baseAsset: 'NVDA', quoteAsset: 'USDC', category: 'rwa', pythPriceId: 'b1073854ed24cbc755dc527418f52b7d271f6cc967bbf8d8129112b18860a593', pythSymbol: 'Equity.US.NVDA/USD', price: 0, prevPrice: 0, change24h: 0, volume24h: 145000000, high24h: 0, low24h: 0, openInterest: 95000000, maxLeverage: 20 },
  // Forex Perps
