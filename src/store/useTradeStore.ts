...
const INITIAL_MARKETS: Market[] = [
  ...
  { id: 'doge-usdc', pair: 'DOGE/USDC', baseAsset: 'DOGE', quoteAsset: 'USDC', category: 'crypto', pythPriceId: 'dcef50dd0a4cd2dcc17e45df1676dcb336a11a61c69df7a0299b0150c672d25c', pythSymbol: 'Crypto.DOGE/USD', price: 0.16, prevPrice: 0.155, change24h: 3.2, volume24h: 850000000, high24h: 0, low24h: 0, openInterest: 150000000 },
  { id: 'pepe-usdc', pair: 'PEPE/USDC', baseAsset: 'PEPE', quoteAsset: 'USDC', category: 'crypto', pythPriceId: 'd69731a2e74ac1ce884fc3890f7ee324b6deb66147055249568869ed700882e4', pythSymbol: 'Crypto.PEPE/USD', price: 0.000010, prevPrice: 0.000009, change24h: 11.1, volume24h: 420000000, high24h: 0, low24h: 0, openInterest: 85000000 },
  { id: 'wif-usdc', pair: 'WIF/USDC', baseAsset: 'WIF', quoteAsset: 'USDC', category: 'crypto', pythPriceId: '4ca4beeca86f0d164160323817a4e42b10010a724c2217c6ee41b54cd4cc61fc', pythSymbol: 'Crypto.WIF/USD', price: 2.80, prevPrice: 3.00, change24h: -6.6, volume24h: 310000000, high24h: 0, low24h: 0, openInterest: 65000000 },
  { id: 'sui-usdc', pair: 'SUI/USDC', baseAsset: 'SUI', quoteAsset: 'USDC', category: 'crypto', pythPriceId: '23d7315113f5b1d3ba7a83604c44b94d79f4fd69af77f804fc7f920a6dc65744', pythSymbol: 'Crypto.SUI/USD', price: 1.15, prevPrice: 1.10, change24h: 4.5, volume24h: 180000000, high24h: 0, low24h: 0, openInterest: 45000000 },
  { id: 'apt-usdc', pair: 'APT/USDC', baseAsset: 'APT', quoteAsset: 'USDC', category: 'crypto', pythPriceId: '03ae4db29ed4ae33d323568895aa00337e658e348b37509f5372ae51f0af00d5', pythSymbol: 'Crypto.APT/USD', price: 8.90, prevPrice: 8.85, change24h: 0.5, volume24h: 150000000, high24h: 0, low24h: 0, openInterest: 38000000 },
  { id: 'avax-usdc', pair: 'AVAX/USDC', baseAsset: 'AVAX', quoteAsset: 'USDC', category: 'crypto', pythPriceId: '93da3352f9f1d105fdfe4971cfa80e9dd777bfc5d0f683ebb6e1294b92137bb7', pythSymbol: 'Crypto.AVAX/USD', price: 35.00, prevPrice: 36.50, change24h: -4.1, volume24h: 210000000, high24h: 0, low24h: 0, openInterest: 55000000 },
  { id: 'bnb-usdc', pair: 'BNB/USDC', baseAsset: 'BNB', quoteAsset: 'USDC', category: 'crypto', pythPriceId: '2f95862b045670cd22bee3114c39763a4a08beeb663b145d283c31d7d1101c4f', pythSymbol: 'Crypto.BNB/USD', price: 600.00, prevPrice: 590.00, change24h: 1.6, volume24h: 650000000, high24h: 0, low24h: 0, openInterest: 210000000 },
  { id: 'xrp-usdc', pair: 'XRP/USDC', baseAsset: 'XRP', quoteAsset: 'USDC', category: 'crypto', pythPriceId: 'ec5d399846a9209f3fe5881d70aae9268c94339ff9817e8d18ff19fa05eea1c8', pythSymbol: 'Crypto.XRP/USD', price: 0.52, prevPrice: 0.53, change24h: -1.8, volume24h: 820000000, high24h: 0, low24h: 0, openInterest: 320000000 },
  { id: 'near-usdc', pair: 'NEAR/USDC', baseAsset: 'NEAR', quoteAsset: 'USDC', category: 'crypto', pythPriceId: 'c415de8d2eba7db216527dff4b60e8f3a5311c740dadb233e13e12547e226750', pythSymbol: 'Crypto.NEAR/USD', price: 7.20, prevPrice: 6.80, change24h: 5.8, volume24h: 120000000, high24h: 0, low24h: 0, openInterest: 28000000 },
  // RWA Perps
