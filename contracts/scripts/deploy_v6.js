...
async function main() {
    console.log("🚀 Starting Deployment of Confidential DEX V6 (Guaranteed Execution & Buffer)");
    ...
    // 1. Deploy New Trading (V6)
    console.log("1️⃣ Deploying ConfidentialTrading V6...");
    ...
    console.log(`✅ ConfidentialTrading V6 deployed to: ${tradingAddress}`);

    // 2. Update Core
    console.log(`2️⃣ Updating Core to point to new Trading Contract V6...`);
    ...
    await tx.wait();
    console.log(`✅ Core linked to New Trading V6.`);
    ...
    console.log("==================================================");
    console.log("🚀 DEPLOYMENT V6 COMPLETE!");
